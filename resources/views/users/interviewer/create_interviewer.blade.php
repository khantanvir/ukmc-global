...
@section('admin')
    <div class="layout-px-spacing">
        <div class="middle-content container-xxl p-0">
                            ...
                            <div class="page-header">
                                ...
                                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Create Interviewer</li>
                                    </ol>
                                </nav>
            ...
            <form method="post" action="{{ URL::to('create-interviewer-data-post') }}" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col">
                                    <div class="form-group mb-4"><label for="exampleFormControlInput1">Interviewer
                                            Name</label>
                                            <input name="interviewer_name" value="{{ old('interviewer_name') }}" type="text" class="form-control">
                                ...
                                <div class="col">
                                    <div class="form-group mb-4"><label for="exampleFormControlInput1">Interviewer
                                            Phone</label>
                                            <input name="interviewer_phone" value="{{ old('interviewer_phone') }}" type="text" class="form-control">
                                ...
                                <div class="col">
                                    <div class="form-group mb-4"><label for="exampleFormControlInput1">Interviewer
                                            Email</label>
                                            <input name="interviewer_email" value="{{ old('interviewer_email') }}" type="email" class="form-control">
                            ...
                            <div class="row mb-4">
                                <div class="col">
                                    <div class="form-group mb-4"><label for="exampleFormControlInput1">Alternative Person
                                            Contact</label>
                                            <input name="interviewer_alternative_contact" value="{{ old('interviewer_alternative_contact') }}" type="text" class="form-control">
                                            @if ($errors->has('interviewer_alternative_contact'))
                                                <span class="text-danger">{{ $errors->first('interviewer_alternative_contact') }}</span>
                                            @endif
                                        <!---->
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group mb-4"><label for="exampleFormControlInput1">National ID or
                                            Passport</label>
                                            <input name="interviewer_nid_or_passport" value="{{ old('interviewer_nid_or_passport') }}" type="text" class="form-control">
                ...
                <div id="card_1" class="col-lg-12 layout-spacing layout-top-spacing">
                    <div class="statbox widget box box-shadow">
                        <div class="widget-content widget-content-area">
                            <div class="row mb-4">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4>Interviewer Login Information</h4><br>
                                </div>
                                <div class="col">
