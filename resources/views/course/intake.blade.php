                    ...
                    <table id="zero-config" class="table dt-table-hover text-center" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr class="">
                                ...
                                <td>
                                    <a title="Create Group" href="{{ URL::to('course-intake-group-list/'.$row->id) }}" class="badge badge-pill bg-warning">
                                    ...
                                    <a title="Edit Course Intake" href="{{ URL::to('course/intake/'.$row->course_id.'/'.'edit/'.$row->id) }}" class="badge badge-pill bg-danger">
